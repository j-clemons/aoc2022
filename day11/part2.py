    ...
    for _ in range(0, 10000):
        ...
        for i in range(0, 8):
            ...
            while True:
                ...
                if dest == 0:
                    m0.items.put(tmp, timeout=0.01)
                elif dest == 1:
                    m1.items.put(tmp, timeout=0.01)
                elif dest == 2:
                    m2.items.put(tmp, timeout=0.01)
                elif dest == 3:
                    m3.items.put(tmp, timeout=0.01)
                elif dest == 4:
                    m4.items.put(tmp, timeout=0.01)
                elif dest == 5:
                    m5.items.put(tmp, timeout=0.01)
                elif dest == 6:
                    m6.items.put(tmp, timeout=0.01)
                elif dest == 7:
                    m7.items.put(tmp, timeout=0.01)
